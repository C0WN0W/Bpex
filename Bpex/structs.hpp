...
{
	Vector3 WorldHeadBone{};
	Vector3 WorldNeckBone{};
	Vector3 WorldChestBone{};
	Vector3 WorldWaistBone{};
	Vector3 WorldBotmBone{};

	Vector3 WorldLeftshoulderBone{};
	Vector3 WorldLeftelbowBone{};
	Vector3 WorldLeftHandBone{};
	Vector3 WorldRightshoulderBone{};
	Vector3 WorldRightelbowBone{};
	Vector3 WorldRightHandBone{};

	Vector3 WorldLeftThighsBone{};
	Vector3 WorldLeftkneesBone{};
	Vector3 WorldLeftlegBone{};
	Vector3 WorldRightThighsBone{};
	Vector3 WorldRightkneesBone{};
	Vector3 WorldRightlegBone{};
